...
# ════════════════════════════════════════════════════════════════════════════
    ...
    with tab_map:
        ...
        st.caption(
            "셀을 **더블클릭**하면 서류명·비고·통화를 직접 입력할 수 있습니다. "
            "새 거래처 추가는 테이블 맨 아래 빈 행에 입력하세요. "
            "서류명·통화는 오른쪽 참고 목록을 참고해서 입력하세요.\n\n"
        ...
        col_table, col_ref = st.columns([3, 1])
        ...
        with col_table:
            edited_df = st.data_editor(
                ...
                column_config={
                    "거래처명": st.column_config.TextColumn(
                        "거래처명", width="medium"),
                    "서류명": st.column_config.TextColumn(
                        "서류명", width="large",
                        help="오른쪽 참고 목록에서 복사하거나 직접 입력하세요."),
                    "비고": st.column_config.TextColumn(
                        "비고", width="medium"),
                    "통화": st.column_config.TextColumn(
                        "통화", width="small",
                        help="오른쪽 참고 목록에서 통화코드를 입력하세요. 예: USD"),
                },
                key="mapping_editor",
                height=500,
            )
